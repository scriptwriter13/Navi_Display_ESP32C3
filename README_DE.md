...
* Smart Preview: Vorausschauendes Icon für den darauffolgenden Manöver-Schritt.
* Dynamische Distanzberechnung: Automatisches Herunterzählen der Meter basierend auf der aktuellen Geschwindigkeit, auch wenn die App gerade keine Daten sendet.
* Intelligentes UI: 
    * Startscreen mit MAC-Adresse zur einfachen Kopplung.
    * Farbliches Feedback bei kritischen Distanzen.
* Gestensteuerung: Helligkeitsregelung und Display-Rotation per Touch-Geste am Display.
